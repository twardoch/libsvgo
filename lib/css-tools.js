...
function compareSimpleSelectorNode (aSimpleSelectorNode, bSimpleSelectorNode) {
  ...
  var bSpecificity = specificity(bSimpleSelectorNode)
...
function csstreeToStyleDeclaration (declaration) {
  ...
  var propertyValue = csstree.generate(declaration.value)
  var propertyPriority = (declaration.important ? 'important' : '')
  return {
    name: propertyName,
    value: propertyValue,
