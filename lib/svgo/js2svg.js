import { elemsGroups } from '../../plugins/_collections'
const textElem = elemsGroups.textContent.concat('title')
 ...
 */
const createJS2SVG = function (data, config) {
