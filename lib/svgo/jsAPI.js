import {
  selectAll as CssSelectSelectAll,
  selectOne as CssSelectSelectOne,
  is as CssSelectIs
} from 'css-select'
...
const JSAPI = function (data, parentNode) {
...
JSAPI.prototype.computedAttr = function (name, val) {
  ...
  let elem = this
  for (; elem && (!elem.hasAttr(name) || !elem.attr(name).value); elem = elem.parentNode) {}
...
JSAPI.prototype.querySelectorAll = function (selectors) {
  const matchedEls = CssSelectSelectAll(selectors, this, cssSelectOpts)
...
JSAPI.prototype.querySelector = function (selectors) {
  return CssSelectSelectOne(selectors, this, cssSelectOpts)
}
...
JSAPI.prototype.matches = function (selector) {
  return CssSelectIs(this, selector, cssSelectOpts)
}
